...
function oxygen_init_offcanvas($) {
  ...
  $(".oxy-off-canvas .offcanvas-inner").each(function () {
    ...
    if (false !== offCanvas.data("stagger-menu")) {
      offCanvas
        .find(".oxy-slide-menu_list > .menu-item")
        .addClass("aos-animate");
      offCanvas
        .find(".oxy-slide-menu_list > .menu-item")
        .attr({ "data-aos": offCanvas.data("stagger-menu") });
    }

    if (!$(this).hasClass("oxy-off-canvas-toggled")) {
      $(this)
        .find(".aos-animate:not(.oxy-off-canvas-toggled .aos-animate)")
        .addClass("aos-animate-disabled")
    ...
    if ($(triggerSelector).hasClass("oxy-burger-trigger")) {
      let triggerSelectorTouch = $(triggerSelector)
        .children(".hamburger")
        .data("touch");
      let touchEvent =
        "ontouchstart" in window ? triggerSelectorTouch : "click";
    ...
    if (maybeHashClose === true) {
      $(document).on(
        ...
        function (e) {
          ...
          if (
            !$(this).not(".menu-item-has-children > a") ||
            $(this).is('[href="#"]')
          ) {
            return;
          }
    ...
    function openOffCanvas() {
      ...
      offCanvas
        .find(".aos-animate-disabled")
        .removeClass("aos-animate-disabled")
        .addClass("aos-animate");
    ...
    function closeBurger() {
      if (
        $(triggerSelector).children(".hamburger").length > 0 &&
    ...
    function extrasOpenOffcanvas($extras_offcanvas) {
      ...
      var thisoffcanvasPushContent = thisOffcanvas
        .children(".offcanvas-inner")
        .data("content-selector");
      var thisoffCanvasFocusSelector = thisOffcanvas
        .children(".offcanvas-inner")
        .data("focus-selector");
